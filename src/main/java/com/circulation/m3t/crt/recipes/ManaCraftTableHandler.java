...
public class ManaCraftTableHandler implements M3TCrtReload {
    ...
    private static final List<RecipesOreTable> addManaCraftTableRecipes = new ArrayList<>();
    private static final List<ItemStack> removeManaCraftTableRecipes = new ArrayList<>();
    private static final List<RecipesOreTable> defManaCraftTableRecipes = new ArrayList<>();
    ...
    public void postReload(){
        if (defManaCraftTableRecipes.isEmpty()){defManaCraftTableRecipes.addAll(ManaCraftTableRecipes);}
